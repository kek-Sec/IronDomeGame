...
export function showBetweenWaveScreen(state: GameState, callbacks: Record<string, () => void>, gameConfig: typeof config): void {
...
export function hideModal(): void { modalContainer.style.display = 'none'; }